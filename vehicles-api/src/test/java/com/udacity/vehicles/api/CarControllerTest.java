...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        ...
        mvc.perform(get("/cars"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$._embedded.carList[0].details.body").value("sedan"))
    ...
    public void deleteCar() throws Exception {
        ...
        Long carId=1L;
        // Act: Perform the DELETE request using MockMvc.
        mvc.perform(delete("/cars/{id}", carId)
                 .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent());

        // Verify: Ensure the carService's deleteById method was called with the correct ID.
